...
@section('title', 'Forkk | Team Members')
                                ...
                                <div class="card-body">
                                    <div class="row px-3 mt-3">
                                        <div style="border: 1px dashed #ffb400;" class="col-md-12 rounded mb-5 p-2">
                                            <span><strong>Note :</strong> Please use a different browser to view the Team Member login access. For security reasons do not open the Team Member access in the same browser.or log out from your admin and then check with Team Member access. There are no automation involved and you need to reach out to your Team Member manually.</span>
                                        </div>
                                    </div>
                                  <div class="row">
                                    ...
                                    <div class="col-sm-12 pb-3 pt-3">
                                        <button class="btn btn-danger float-right p-2" type="button" data-toggle="modal" data-target="#tooltipmodal">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <span class="font-weight-bolder">Add Team Members</span>
                                            </div>
                                        </button>
                                                ...
                                                <div class="modal-header">
                                                    <h5 class="modal-title">
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <span class="font-weight-bolder">ADD NEW TEAM MEMBER</span>
                                                        </div>
                                                    </h5>
                                                ...
                                                <div class="modal-body">
                                                    <div class="form-group m-form__group">
                                                        <label>Name <i class="fa fa-question-circle mytooltip"
                                                                ...
                                                                data-original-title="Enter Your Team Member Name."></i></label>
                                                        <div class="input-group-prepend"><span
                                                                class="input-group-text"><i data-feather="user"></i></span>
                                                            <input class="form-control" id="f1-first-name" type="text"
                                                                name="f1-first-name" placeholder="Enter Team Member Name"
                                                    ...
                                                    <div class="form-group m-form__group">
                                                        <label>Email <i class="fa fa-question-circle mytooltip"
                                                                data-toggle="tooltip" data-placement="right" title=""
                                                                data-original-title="Enter Your Team Member Email."></i></label>
                                                        <div class="input-group-prepend"><span
                                                                class="input-group-text"><i data-feather="mail"></i></span>
                                                            <input class="form-control" id="f1-first-name" type="email"
                                                                name="f1-first-name" placeholder="Enter Team Member Email"
                                                                data-original-title="" title="">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <small class="form-text cust-small mb-3" style="color: red;font-size: 10px;"><strong>Maximum(px):</strong> 1000*1000</small>
                                                    <div class="form-group m-form__group">
                                                        <label>Password <i class="fa fa-question-circle mytooltip"
                                                                data-toggle="tooltip" data-placement="right" title=""
                                                                data-original-title="Enter your Team Member password."></i></label>
                                                        <div class="input-group-prepend"><span
                                                                class="input-group-text"><i data-feather="lock"></i></span>
                                                            <input class="form-control" id="f1-first-name" type="email"
                                                                name="f1-first-name" placeholder="Enter Team Member Password"
                                                                data-original-title="" title="">
                                                        </div>
                                                    </div>
                                                    <div class="form-group m-form__group">
                                                        <label>Confirm Password <i class="fa fa-question-circle mytooltip"
                                                                data-toggle="tooltip" data-placement="right" title=""
                                                                data-original-title="Enter your Team Member confirm password."></i></label>
                                                        <div class="input-group-prepend"><span
                                                                class="input-group-text"><i data-feather="lock"></i></span>
                                                            <input class="form-control" id="f1-first-name" type="email"
                                        ...
                                        <td>
                                            <div class="btn-group" role="group">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="btnGroupVerticalDrop1">
                                                    ...
                                                    <a class="dropdown-item" href="#"><i class="icofont icofont-listine-dots"></i> Access Restriction</a>
